...
#先查询出所有的数据，然后删除,返回的是删除的数量
#student = session.query(Student).delete()
#student = session.query(Student).delete(5)#不存在这种用法
#student = session.query(Student).get(5).delete()#不存在这种用法
#如果想要删除指定的数据怎么操作呢？
